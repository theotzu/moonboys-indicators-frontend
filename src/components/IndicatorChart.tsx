            ...
            <button
              ...
              className={`min-h-11 min-w-11 px-4 py-2.5 rounded-md text-sm font-semibold transition-colors ${
                symbol === s.value
                  ...
                  : "bg-[#1e1730] text-gray-300 hover:bg-[#2a2240]"
              }`}
            >
              {s.label}
            </button>
          ...
          return (
            <div
              ...
              className={`rounded-xl border overflow-hidden flex flex-col transition-opacity ${
                hidden
                  ? "border-[#1e1730] bg-[#15101f]/30 opacity-40"
                  : "border-purple-500/25 bg-[#15101f]/60"
              }`}
            >
              {/* Screenshot preview */}
              ...
              <a
                ...
                className={`mt-auto flex items-center justify-center gap-2 py-2 px-4 rounded-lg text-sm font-semibold transition-colors ${
                  hidden
                    ? "bg-[#1e1730] text-gray-600 cursor-not-allowed pointer-events-none"
                    : "bg-purple-500/10 border border-purple-500/40 text-purple-300 hover:bg-purple-500/20 hover:text-purple-200"
                }`}
              >
