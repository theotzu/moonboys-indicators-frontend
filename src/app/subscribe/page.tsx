    ...
    <div className="min-h-screen px-6 py-20">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          <span className="inline-block px-3 py-1 mb-4 text-xs font-semibold tracking-widest uppercase text-purple-300 border border-purple-500/40 rounded-full bg-purple-500/10">
            Premium Access
          </span>
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4">
            Unlock the{" "}
            <span className="text-purple-300">Full Moon Boys Suite</span>
          </h1>
        ...
        {!isConnected && (
          <div className="flex flex-col items-center gap-4 mb-14 p-8 rounded-xl border border-purple-500/30 bg-purple-500/5">
            ...
            <div
              ...
              className={`relative rounded-xl border p-8 flex flex-col gap-6 ${
                tier.highlight
                  ...
                  : "border-purple-500/20 bg-[#15101f]/50"
              }`}
            >
              {tier.highlight && (
                <span className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 text-xs font-bold uppercase tracking-widest bg-purple-500 text-white rounded-full">
                  Best Value
                </span>
              )}
              ...
              <button
                ...
                className={`w-full py-3 rounded-lg font-bold transition-colors ${
                  isConnected
                    ...
                    : "bg-[#1e1730] text-gray-500 cursor-not-allowed"
                }`}
                onClick={() => {
